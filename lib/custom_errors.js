...
class ForbiddenCountryError extends Error {
	constructor() {
		super()
		this.name = 'ForbiddenCountryError'
		this.message = "Service is forbidden for this country"
	}
}
...
const handleForbiddenCountry = (response) => { 
	if (+response.count > 0) {
		throw new ForbiddenCountryError()
	} else {
		return response
	}
}
...
module.exports = {
	...
	BadParamsError,
	BadCredentialsError,
	ForbiddenCountryError,
	handleForbiddenCountry
}
